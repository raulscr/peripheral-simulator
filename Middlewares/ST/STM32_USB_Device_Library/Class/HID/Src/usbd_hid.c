...
__ALIGN_BEGIN static uint8_t HID_ReportDesc[]  __ALIGN_END =
{
	...
	0xA1, 0x01,        // COLLECTION (Application)
	0x85, 0x02,        //   REPORT_ID (2)   <-- ID do relatório do mouse
	...
	0x09, 0x30,        //     USAGE (X)
	0x09, 0x31,        //     USAGE (Y)
	0x09, 0x38,        //     USAGE (Wheel)  <-- Adiciona suporte para rolagem do mouse
	0x15, 0x81,        //     LOGICAL_MINIMUM (-127)
	0x25, 0x7F,        //     LOGICAL_MAXIMUM (127)
	0x75, 0x08,        //     REPORT_SIZE (8)
	0x95, 0x03,        //     REPORT_COUNT (3)  <-- Agora inclui o eixo de rolagem
	0x81, 0x06,        //     INPUT (Data,Var,Rel)
	0xC0,              //   END_COLLECTION
	0xC0,               // END_COLLECTION
};

const static uint8_t HID_REPORT_DESC_SIZE = sizeof(HID_ReportDesc);
